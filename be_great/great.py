...
class GReaT:
    ...
    def fit(self, df: tp.Union[pd.DataFrame, np.ndarray],
        ...
        """ Fine-tune a pretrained large language model to tabular data
            ...
            :param conditional_col: If given, the distribution is saved and used as a starting point for the generation
            process later. If not, the last feature is considered as target feature
